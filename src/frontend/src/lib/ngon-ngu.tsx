...
const TU_DIEN: Record<string, { vi: string; en: string }> = {
  ...
  'cmp.bold': { vi: 'In đậm', en: 'Bold' },
  'cmp.italic': { vi: 'In nghiêng', en: 'Italic' },
  'cmp.underline': { vi: 'Gạch chân', en: 'Underline' },
  'cmp.color': { vi: 'Màu chữ', en: 'Text colour' },
  'cmp.bullets': { vi: 'Danh sách gạch đầu dòng', en: 'Bulleted list' },
  'cmp.link': { vi: 'Chèn liên kết', en: 'Insert link' },
  'cmp.linkPrompt': { vi: 'Dán địa chỉ liên kết:', en: 'Paste the link URL:' },
  'cmp.clearFormat': { vi: 'Xoá định dạng', en: 'Clear formatting' },
